...
class PlayerBot(Bot):
    def play_round(self):
        if self.round_number == 1:
            ...
            yield pages.Q1, dict(Q1='clinton')
            yield pages.Q2, dict(Q2='ohio')
            yield pages.Q3, dict(Q3='england')
            yield pages.Q4, dict(Q4='japan')
            yield pages.Q5, dict(Q5='hitler')
            yield pages.Q6, dict(Q6='michelangelo')
            yield pages.Q7, dict(Q7='communism')
            yield pages.Q8, dict(Q8='1950-1960')
            yield pages.Q9, dict(Q9='franklin d. roosevelt')
            yield pages.Q10, dict(Q10='sacajawea')
