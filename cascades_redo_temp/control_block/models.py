...
class Subsession(BaseSubsession):
    ...
    def initialization(self):
        ...
        # It sets the states for the sequences and dumps them into the relevant history variables for the groups
...
class Player(BasePlayer):
    ...
    # Red_post_red(i) - post guess if signal is Red for ith decision
    # Red_post_blue(i) - post guess if signal is Blue for ith decision
    ...
    Red_post_red1 = models.IntegerField(min=0, max=100,
                                   label="Suppose the computer drew a RED ball from the jar. What would you think is the probability (0 to 100%) that the color is Red for this sequence?")
    Red_post_blue1 = models.IntegerField(min=0, max=100,
                                       label="Suppose the computer drew a BLUE ball from the jar. What would you think is the probability (0 to 100%) that the color is Red for this sequence?")
    ...
    Red_pre2 = models.IntegerField(min=0, max=100,
                                   label="What do you think is the probability (0 to 100%) that the color is Red for this sequence?")
    Red_post_red2 = models.IntegerField(min=0, max=100,
                                        label="Suppose the computer drew a RED ball from the jar. What would you think is the probability (0 to 100%) that the color is Red for this sequence?")
    Red_post_blue2 = models.IntegerField(min=0, max=100,
                                         label="Suppose the computer drew a BLUE ball from the jar. What would you think is the probability (0 to 100%) that the color is Red for this sequence?")
    ...
    Red_pre3 = models.IntegerField(min=0, max=100,
                                   label="What do you think is the probability (0 to 100%) that the color is Red for this sequence?")
    Red_post_red3 = models.IntegerField(min=0, max=100,
                                        label="Suppose the computer drew a RED ball from the jar. What do would think is the probability (0 to 100%) that the color is Red for this sequence?")
    Red_post_blue3 = models.IntegerField(min=0, max=100,
                                         label="Suppose the computer drew a BLUE ball from the jar. What would you think is the probability (0 to 100%) that the color is Red for this sequence?")
    ...
    Red_pre4 = models.IntegerField(min=0, max=100,
                                   label="What do you think is the probability (0 to 100%) that the color is Red for this sequence?")
    RRed_post_red4 = models.IntegerField(min=0, max=100,
                                   label="Suppose the computer drew a RED ball from the jar. What do would think is the probability (0 to 100%) that the color is Red for this sequence?")
    Red_post_blue4 = models.IntegerField(min=0, max=100,
                                       label="Suppose the computer drew a BLUE ball from the jar. What would you think is the probability (0 to 100%) that the color is Red for this sequence?")
    ...
    Red_pre5 = models.IntegerField(min=0, max=100,
                                   label="What do you think is the probability (0 to 100%) that the color is Red for this sequence?")
    Red_post_red5 = models.IntegerField(min=0, max=100,
                                        label="Suppose the computer drew a RED ball from the jar. What would you think is the probability (0 to 100%) that the color is Red for this sequence?")
    Red_post_blue5 = models.IntegerField(min=0, max=100,
                                         label="Suppose the computer drew a BLUE ball from the jar. What would you think is the probability (0 to 100%) that the color is Red for this sequence?")
    ...
    Red_pre6 = models.IntegerField(min=0, max=100,
                                   label="What do you think is the probability (0 to 100%) that the color is Red for this sequence?")
    Red_post_red6 = models.IntegerField(min=0, max=100,
                                        label="Suppose the computer drew a RED ball from the jar. What would you think is the probability (0 to 100%) that the color is Red for this sequence?")
    Red_post_blue6 = models.IntegerField(min=0, max=100,
                                         label="Suppose the computer drew a BLUE ball from the jar. What would you think is the probability (0 to 100%) that the color is Red for this sequence?")
