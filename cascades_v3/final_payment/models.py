    ...
    def final_payoffs(self):
        ...
        for p in self.get_players():
            ...
            if p.payment_block == 1:
                ...
                p.payment_guess = p.participant.vars['paying_guess_1']
                ...
                p.payment_guess = p.participant.vars['paying_guess_2']
                ...
                p.payment_guess = p.participant.vars['paying_guess_3']
                ...
                p.payment_guess = p.participant.vars['paying_guess_4']
                ...
                p.payment_guess = p.participant.vars['paying_guess_5']
...
class Player(BasePlayer):
    ...
    payment_guess = models.IntegerField()
