...
class Player(BasePlayer):
    ...
    # Variables for quiz questions - Q1 to Q10 (one for each quiz) - This is from Bank A - Geography Easy
    ...
    def quiz_profit_calc(self):
        ...
        self.participant.vars[
            'other_question_2'] = self.question_other  # question chosen for belief elicitation payment
