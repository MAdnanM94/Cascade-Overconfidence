...
class Player(BasePlayer):
    ...
    # Variables for quiz questions - Q1 to Q10 (one for each quiz) - This is from Bank A - Entertainment Easy
    ...
    def quiz_profit_calc(self):
        ...
        # Loading the dataset
        data = pd.read_csv('_static/quizB.csv')
